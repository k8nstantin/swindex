...
- Connect to Claude / similar agent; demo answering "find me 3BR houses in 78704 with no flood risk, no liens, recent HVAC"
...
Tools exposed to any Claude / GPT / Gemini / other agent via the Model Context Protocol:
...
6. **Agent integration**: Claude connected via MCP; complex query routed through substrate; verify response token count is 5–20× lower than equivalent SQL/REST approach.
